...
BOOST_AUTO_TEST_CASE(abi_encode)
{
	...
	compileAndRun(sourceCode, 0, "C");
	ABI_CHECK(callContractFunction("f()"), encodeArgs(u256(32), u256(96), u256(64), u256(1), u256(2)));
	ABI_CHECK(callContractFunction("g()"), encodeArgs(u256(32), u256(96), u256(64), u256(1), u256(2)));
}
